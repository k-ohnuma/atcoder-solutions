...
export const Body = withContext<HTMLTableSectionElement, Assign<HTMLStyledProps<"tbody">, PolymorphicProps>>(ark.tbody, "body");
...
export const Head = withContext<HTMLTableSectionElement, Assign<HTMLStyledProps<"head">, PolymorphicProps>>(ark.thead, "head");

export const Header = withContext<HTMLTableCellElement, Assign<HTMLStyledProps<"th">, PolymorphicProps>>(ark.th, "header");
