...
mod tests {
    ...
    fn deserialize_update_solution_request_from_camel_case() {
        ...
        let input = from_req_for_input("uid".to_string(), solution_id, req);
    ...
    #[test]
    fn deserialize_update_solution_request_requires_update_body_fields() {
        let raw = json!({
            "bodyMd": "new body",
            "submitUrl": "",
            "tags": ["dp"]
        ...
        let result = serde_json::from_value::<UpdateSolutionRequest>(raw);
